  ...
  return (
    <ChakraProvider>
      <Box p={4} background='linear-gradient(to left, #ff5757, #8c52ff)' color="white" minHeight="100vh">
        ...
        <Box p={1}>
          <center>
            <UnorderedList listStyleType="none" style={{maxWidth:"1200px"}}>
              {doctorsData.map((doctor, index) => (
                <ListItem key={index} m={4} boxShadow="md" borderRadius="md">
                  <Flex
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <Box ml={{ base: 0, md: 4 }} textAlign="left">
          ...
          <Button onClick={()=>{
            navigate("/form")
          }}  colorScheme='red' marginLeft="125px">Back to form</Button>
        </Box>
      </Box>
